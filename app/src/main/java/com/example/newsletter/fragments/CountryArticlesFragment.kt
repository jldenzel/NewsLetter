...
import com.example.newsletter.data.CountryRepository
import com.example.newsletter.models.Article
import com.example.newsletter.models.ArticleResponse
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class CountryArticlesFragment (subject: String): Fragment(), ListArticlesHandler {
    ...
    private fun getArticles(subject: String) {
        lifecycleScope.launch(Dispatchers.IO) {
            val articles = CountryRepository.getInstance().getArticles(subject)
            bindData(articles)
        }
    }
    ...
    private fun bindData(articles: ArticleResponse) {
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            val adapter = ArticleAdapter(articles,this@CountryArticlesFragment)
